...
.bottom{
    ...
    <!-- Center Box -->
        <div class ="rcorners">
            <h1> Input Quarter Start and End </h1>
                <form action ="datesCheck.php" method ="post">
                    <label> Start Date </label>
                    <input type="date" id="start" name="start"
                        min="2019-01-01" max="2025-12-31" required>
                    <label> End Date </label>
                        <input type="date" id="end" name="end"
                        min="2019-01-01" max="2025-12-31" required><br>
                    <p> If you want to enter the specific due dates in the quarter click <a href = "inputWeeks.php"> HERE </a> </p>
