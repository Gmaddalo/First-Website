...
?>
<html>
<title> Edit or Delete Your Data </title>
<head>
...
<div id = "page-container">
    <div id = "content-wrap">
        ...
        <div class = "section1">
            ...
            <div align ="center">
                <h1> What data would you like to edit? </h1>
                    <div class= "img1">
                        <img src = "https://cdn.mos.cms.futurecdn.net/g4fzdMN2kwwoKuvFKFnFVc.jpg">
                    </div>
                    <div class ="links">
                        <a href = "editActuals.php"> Actuals </a></br>
                        <a href = "editBudgets.php"> Budgets </a></br>
                        <a href = "editExpenses.php"> Expenses </a></br></br>
                    </div>
            


                
                <h1> What data would you like to delete?</h1></br>
                    <div class = "img2">
                        <img src = "https://static.thenounproject.com/png/735690-200.png">
                    </div>
                    <div class = "links">
                        <a href = "deleteActuals.php"> Actuals </a></br>
                        <a href = "deleteBudgets.php"> Budgets </a></br>
                        <a href = "deleteExpenses.php"> Expenses </a></br>
                        <a href = "deleteForecasts.php"> Forecasts </a></br>
                    </div>
