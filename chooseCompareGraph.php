...
.placement {
    padding-left:50px;
        ...
        <!-- Stuff in the box -->
        <div class ="rcorners">
            <h1> Choose Your Graph </h1>
                <form action = "CompareGraph.php" method = "post" >
                    What would you like to compare? <select id ="compare" name = "compare">
                        <option value = "1"> Forecasts, Actuals, and Budget </option>
                        <option value ="2"> Forecasts and Actuals </option>
                        <option value = "3"> Forecasts and Budget </option>
                        <option value= "4"> Actuals and Budget </option>
                    </select>
