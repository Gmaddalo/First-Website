...
if($expense == "Headcount"){
    //sql Statement
    if($stmt = $conn->query("SELECT Week_in_quarters.Day_due, Year_Forecast.Amount FROM Year_Forecast JOIN Week_in_quarters ON (Week_in_quarters.Week_quarter_ID = Year_Forecast.Week_quarter_ID) JOIN Expense_Type ON(Expense_Type.Type_ID = Year_Forecast.Type_ID) WHERE Year_Forecast.Admin_ID = '$id' AND Expense_type_name = 'Headcount' AND Week_in_quarters.Quarter_ID = '$quarterid' AND Year_Forecast.Week_quarter_ID = Year_Forecast.Week_quarter_ID")){
...
<!-- Title -->
<h1 align ="center"> Headcount Forecast (USD) </h1>
<!-- Chart creator -->
...
// Discretionary
    ...
    if($stmt = $conn->query("SELECT Week_in_quarters.Day_due, Year_Forecast.Amount FROM Year_Forecast JOIN Week_in_quarters ON (Week_in_quarters.Week_quarter_ID = Year_Forecast.Week_quarter_ID) JOIN Expense_Type ON(Expense_Type.Type_ID = Year_Forecast.Type_ID) WHERE Year_Forecast.Admin_ID = '$id' AND Expense_type_name = 'Discretionary' AND Week_in_quarters.Quarter_ID = '$quarterid' AND Year_Forecast.Week_quarter_ID = Year_Forecast.Week_quarter_ID ")){
...
<!-- Title -->
<h1 align  ="center"> Discretionary Forecasts (USD) </h1>
<!-- chart --->
<div id="curve_chart"></div>
...
//Controllable
    ...
    // SQL statement
    if($stmt = $conn->query("SELECT Week_in_quarters.Day_due, Year_Forecast.Amount FROM Year_Forecast JOIN Week_in_quarters ON (Week_in_quarters.Week_quarter_ID = Year_Forecast.Week_quarter_ID) JOIN Expense_Type ON(Expense_Type.Type_ID = Year_Forecast.Type_ID) WHERE Year_Forecast.Admin_ID = '$id' AND Expense_type_name = 'Controllable' AND Week_in_quarters.Quarter_ID = '$quarterid' AND Year_Forecast.Week_quarter_ID = Year_Forecast.Week_quarter_ID ")){
...
<!-- Title -->
<h1 align = "center"> Controllable Forecasts (USD) </h1>
<!-- Chart -->
<div id="curve_chart"></div>
...
//Outsource
    ...
    //SQL statement
    if($stmt = $conn->query("SELECT Week_in_quarters.Day_due, Year_Forecast.Amount FROM Year_Forecast JOIN Week_in_quarters ON (Week_in_quarters.Week_quarter_ID = Year_Forecast.Week_quarter_ID) JOIN Expense_Type ON(Expense_Type.Type_ID = Year_Forecast.Type_ID) WHERE Year_Forecast.Admin_ID = '$id' AND Expense_type_name = 'Outsource' AND Week_in_quarters.Quarter_ID = '$quarterid' AND Year_Forecast.Week_quarter_ID = Year_Forecast.Week_quarter_ID")){
...
<!-- Title -->
<h1 align = "center"> Outsource Forecasts (USD) </h1>
<!-- Chart -->
<div id="curve_chart"></div>
...
//Total
    ...
    if($stmt = $conn->query("SELECT Week_in_quarters.Day_due, SUM(Year_Forecast.Amount) AS Amount FROM Year_Forecast JOIN Week_in_quarters ON (Week_in_quarters.Week_quarter_ID = Year_Forecast.Week_quarter_ID) JOIN Expense_Type ON(Expense_Type.Type_ID = Year_Forecast.Type_ID) WHERE Year_Forecast.Admin_ID = '$id' AND Week_in_quarters.Quarter_ID = '$quarterid' AND Year_Forecast.Week_quarter_ID = Year_Forecast.Week_quarter_ID
GROUP BY Year_Forecast.Week_quarter_ID")){
...
<!-- Title -->
<h1 align = "center"> Total of all Expenses for Forecasts (USD) </h1>
<!-- Chart -->
<div id="curve_chart"></div>
...
?>
            ...
            <div align = "center">
                <div class = "btn">
                    <div class = "links2">
                        <a href = "chooseForecastsGraph.php"> Back </a>
                    </div>
                </div></br> </br></br></br>
            </div>  
