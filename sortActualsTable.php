...
<?php
    ...
    // Sort by discretionary
    }else if($select == 'Discretionary'){

        $result = mysqli_query($conn, "SELECT * FROM Actuals  
    ...
    //Sort by amount
        ...
        echo "<h1 align ='center'> Sort by Amount  </h1>";
        echo "<table width = '600px' border='1' align ='center'>
        <tr>
        <th>Amount (USD)</th>
        <th>Expense Type</th>
    ...
    ?><br>
            ...
            <form action = "sortActualsTable.php" method = "post" align ="center">
