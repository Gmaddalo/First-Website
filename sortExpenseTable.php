...
<?php
    ...
    //Sort by name
        ...
        JOIN Week_in_quarters ON (Week_in_quarters.Week_quarter_ID = Expenses.Week_quarter_ID) 
        JOIN Quarters ON (Quarters.Quarter_ID = Week_in_quarters.Quarter_ID)
        WHERE Admin_ID = '$adminID' 
        ORDER BY Expenses.Expense_name ASC");
        ...
        echo "<h1 align = 'center'> Table Sorted by Name </h1>";
        ...
        //Sort by amount
            ...
            echo "<h1 align = 'center'> Table Sorted by Amount </h1>";
            echo "<table  width='600px' border='1' align ='center'>
            <tr>
            <th>Name</th>
            <th>Amount (USD) </th>
        ...
        //Sort by date
            ...
            echo "<h1 align = 'center'> Table Sorted by Date </h1>";
            echo "<table  width='600px' border='1' align ='center'>
            <tr>
            <th>Name</th>
            <th>Amount (USD)</th>
        ...
        //Sort by quarter    
            ...
            echo "<h1 align = 'center'> Table Sorted by Quarter </h1>";
            echo "<table  width='600px' border='1' align ='center'>
            <tr>
            <th>Name</th>
            <th>Amount (USD) </th>
            ...
            <form action = "sortExpenseTable.php" method = "post" align = "center">
            ...
            <!-- Button -->
                        <div align = "center">
                            <div class = "btn">
                                <div class = "links2">
                                    <a href = "viewExpenses.php"> Back </a>
                                </div>
                            </div></br> </br> </br> </br> </br>
                        </div>    
