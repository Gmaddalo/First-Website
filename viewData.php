    ...
    border-radius: 25px 45px 25px 25px;
        ...
        <div id = "page-container">
            <div id = "content-wrap">
                ...
                <div align = "center">
                    <h1> What data would you like to view?</h1>
                        <div class = "img1">
                            <img src = "https://icons-for-free.com/iconfiles/png/512/find+look+search+view+zoom+icon-1320086048988571194.png">
                        </div> 
                            <div class ="links">
                                <a href = "viewExpenses.php"> Expenses </a><br>
                                <a href = "viewForecasts.php"> Forecasts </a><br>
                                <a href = "viewBudgets.php"> Budgets </a><br>
                                <a href = "viewActuals.php"> Actuals </a><br>
                            </div>
                        <!-- Button -->
                        <div align = "center">
                            <div class = "btn">
