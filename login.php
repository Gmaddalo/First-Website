...
<div class = "rcorners2">
    ...
    <h1> Login 
        ...
        <form action = "logincheck.php" method = "post">
            <input type="email" id="uname" name="uname" value = "" placeholder = "Email">
            <input type="password" id="pword" name="pword" value = "" placeholder = "Password"><br>
            <input type="submit" value="Submit">
        </form>
    <p><a href = "homePage.php"> Home Page </a></p>
    <p><a href = "forgotpword.php"> Forgot Password? </a></p>
