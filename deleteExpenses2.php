            ...
            if($row_cnt == 0)
                ...
                <div class = "rcorners">
                    <h1> Do you want to delete this? </h1>
                        <form action = "deleteExpensesCheck.php" method = "post">
                            Expense Name: <input type = "text" name="expenseName" id = "expenseName" value = <?php echo $expenseName ?> readonly>
                    ...
                    <a href = "deleteExpenses.php"> Back </a>
                </div>
