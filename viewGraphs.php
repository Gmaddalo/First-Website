...
<div id = "page-container">
    <div id = "content-wrap">
        ...
        <!-- Main part of page -->
        <h1 align ='center'> What Graph Would You Like to View? </h1>
        <div class = "img1" align = "center">
            <img src = "https://www.seekpng.com/png/detail/52-527586_line-graph-comments-black-and-white-icon-line.png" >
        </div></br>
        <div class = "links" align = "center">
            <a href = "chooseExpensesGraph.php"> Expenses </a> <br>
            <a href = "chooseForecastsGraph.php"> Forecasts </a><br>
            <a href = "chooseBudgetsGraph.php"> Budget </a><br>
            <a href = "chooseActualsGraph.php"> Actuals </a><br>
            <a href = "chooseCompareGraph.php"> Compare   </a><br>
        </div>
