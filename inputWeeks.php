...
.bottom{
    font-size: 18px;
        ...
        <div class ="rcorners">
            <h1> Input the Due Date </h1>
                <form action ="weekCheck.php" method ="post">
                    <label> Due Date </label>
                        <input type="date" id="due" name="due"
                        min="2019-01-01" max="2025-12-31" required>
                    Quarter Start and End Date:<select id="date" name="date" required>
                        <?php
                            $date  = mysqli_query($conn,"SELECT * FROM Quarters");
                            while($row = mysqli_fetch_array($date)){
                                echo "<option value = ".$row['Quarter_ID'].">" . $row['Quarter_start'] . " To ". $row['Quarter_end'] ."</option>";
                            }
                            ?> </select><br>
                    <input type="submit" name="submit" value = "Submit">
                </form><br> <br>
            <a href = "inputDates.php"> Back </a>
        </div>
