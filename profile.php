<?php
session_start();
    // Constraints to Accessing the Page
...
<div id = "page-container">
    <div id = "content-wrap">
        ...
        <div class = "img1" align ="center">
            <h1> Profile </h1>
            <img  src="https://deleesclubvanalles.nl/wp-content/uploads/2019/10/no-placeholderperson.png" alt="">
        </div>
        <!-- Show this link only if admin -->
        <div class ="links" align = "center">
            <a href="changePword.php"> Change Password </a></br>
            <?php 
            if($viewer != true){
                ?> <a href = "newAdminUser.php"> Create a New Admin User </a></br> <?php ;
            }
            ?>    
            <a href = "feedback.php"> Give Feedback </a></br>
            <a href = "LoggedIn.php"> Back </a></br></br>
        </div>
