...
session_start();
    ...
    if(!isset($_SESSION['loggedin'])){
        ...
        header("Location:ViewerLoggedIn.php");
            ...
            ?>
<html>
<title> Input Different Expenses </title>
<head>
    ...
    font-size: 18px;
        ...
        <div class ="rcorners">
            <h1> Input Your Expenses </h1>
                <form action = "checkExpenses.php" method = "post">
                    Amount: <input type = "number" name = "amount" step=".01" required>
                    Name of Expense: <input type="text" name ="name" id ="name">
                    ...
                    Expense Type <select  name="type" id = "type">
                        ...
                        ?></select>
                    Date <div class ="placement">
                        <div class="drop-down">
                            <div id="Dropdown" class="dropdown-content">
                                <input type="text"  id="userInput" onkeyup="Func()">   
                                    <select placeholder = "Search.." id = "date" name = "date">
